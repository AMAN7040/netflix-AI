      ...
      {currentChoose && currentChoose && (
        <>
          ...
          <div className="absolute pt-[10%] w-screen bg-[rgba(0,0,0,0.7)] m-auto  p-4 text-white">
            <h1 className="text-4xl font-bold text-red-500 text-center mb-3">{currentChoose.title}</h1>
            ...
            <p className="text-lg italic text-center mb-3">{currentChoose.tagline}</p>
