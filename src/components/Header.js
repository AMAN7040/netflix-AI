...
const Header = () => {
  ...
  return (
    <div className="absolute px-2 w-screen py-2 z-10 md:flex lg:flex 2xl:flex md:py-4 md:px-25 lg:py-2 lg:px-48  2xl:py-2 2xl:px-60">
      <img className="w-28 mx-36 md:w-32 md:m-1 lg:w-36 lg:m-1 2xl:w-44 2xl:m-1" src={NETFLIX_LOGO} alt="LOGO" />
      {user && (
        <div className="m-1 my-2 p-1  md:flex md: md:space-x-1 md:p-1 lg:flex lg:justify-between lg:m-3 lg:p-1 2xl:flex 2xl:justify-between w-full 2xl:m-5 2xl:p-1">
